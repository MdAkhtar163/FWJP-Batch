...
public class Data 
{
	String state[] = {"Andaman & Nicobar", "Andhra Pradesh", 
	...
	public int getLengthArray(String a[][])
	{
		int count=0;
	...
	{
//		first get the length of the 2-DArray(Different dimension array)
		String arraylist[]=new String[getLengthArray(citystate)];
		
		for(int r=0,i=0;r<citystate.length;r++)
		{
			for(int c=0;c<citystate[r].length;c++)
			{
				arraylist[i++]=citystate[r][c];
			}
		}
		return arraylist;
	}
	...
	{
//		search for state in state array
		String citylist[]=null;
		System.out.println("Going to fetch cities..."+state);
		
		for(int i=0;i<this.state.length;i++)
		{
			if(state.equals(this.state[i]))
			{
				citylist=new String[citystate[i].length];
				System.out.println("state found!!");
				for(int c=0;c<citystate[i].length;c++)
				{
					citylist[c] = citystate[i][c]; 
				}
				return citylist;
